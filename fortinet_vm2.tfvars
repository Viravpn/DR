...
interfaces = [
  {
    ...
    private_ip_address   = "10.212.11.231"
  ...
  },
  {
    ...
    private_ip_address   = "10.212.11.135"
    public_ip_address_id = null
    create_public_ip     = false
    availability_zone    = "1"
  ...
  {
    name                 = "AZ23FORTSDW02-UNTRUST-NIC"
    ...
    private_ip_address   = "10.212.11.167"
    public_ip_address_id = null
    create_public_ip     = false
    availability_zone    = "1"
    enable_ip_forwarding = false
  ...
  },
  {
    ...
    private_ip_address   = "10.212.11.199"
    public_ip_address_id = null
    create_public_ip     = false
    availability_zone    = "1"
    enable_ip_forwarding = false
...
avzones                 = []
avset_id                = null
os_disk_name            = "AZ23FORTSDW02-OS-Disk-01"
