...
resource "azurerm_virtual_machine" "this" {
  ...
  storage_image_reference {
    ...
    publisher = var.custom_image_id == null ? var.publisher : null
    offer     = var.custom_image_id == null ? var.offer : null
    sku       = var.custom_image_id == null ? var.sku : null
    version   = var.custom_image_id == null ? var.fg_version : null
  }
